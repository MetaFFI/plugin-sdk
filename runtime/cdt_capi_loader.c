...
void** (*pxllr_load_function)(const char*, uint32_t, const char*, uint32_t, const char*, uint32_t, metaffi_type_infos_ptr, metaffi_type_infos_ptr, uint8_t, uint8_t, char**, uint32_t*);
void** xllr_load_function(const char* runtime_plugin, uint32_t runtime_plugin_len,
                          ...
                          metaffi_type_infos_ptr params_types, metaffi_type_infos_ptr retval_types,
...
const char* load_xllr_api()
{
	...
	pxllr_load_function = (void** (*)(const char*, uint32_t, const char*, uint32_t, const char*, uint32_t, metaffi_type_infos_ptr, metaffi_type_infos_ptr, uint8_t, uint8_t, char**, uint32_t*))load_symbol(cdt_helper_xllr_handle, "load_function", &out_err, &out_err_len);
