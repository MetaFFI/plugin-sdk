...
std::vector<metaffi_uint64> cdts_wrapper::get_metaffi_uint64_array(int index)
{
...
std::vector<bool> cdts_wrapper::get_bool_array(int index)
{
...
std::vector<metaffi_handle> cdts_wrapper::get_metaffi_handle_array(int index)
{
