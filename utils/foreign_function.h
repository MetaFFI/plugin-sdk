...
#define foreign_function_entrypoint_signature_params_no_ret void(no_params_params_and_ret_types)
#define foreign_function_entrypoint_signature_no_params_ret void(no_params_params_and_ret_types)
...
#define pforeign_function_entrypoint_signature_params_no_ret void(*)(no_params_params_and_ret_types)
#define pforeign_function_entrypoint_signature_no_params_ret void(*)(no_params_params_and_ret_types)
...
typedef void(*pforeign_function_entrypoint_signature_params_no_ret_t)(no_params_params_and_ret_types);
typedef void(*pforeign_function_entrypoint_signature_no_params_ret_t)(no_params_params_and_ret_types);
...
typedef std::function<void(no_params_params_and_ret_types)> foreign_function_entrypoint_signature_no_params_ret_t;
typedef std::function<void(no_params_params_and_ret_types)> foreign_function_entrypoint_signature_params_no_ret_t;
