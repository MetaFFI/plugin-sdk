...
private:
	...
	std::shared_ptr<boost::dll::detail::import_type<void*(const char*, uint32_t, const char*, uint32_t, void*, int8_t, int8_t, char**, uint32_t*)>::type> pload_function;
...
public:
	...
	void* load_function(const char* runtime_plugin, uint32_t runtime_plugin_len, const char* function_path, uint32_t function_path_len, void* pff, int8_t params_count, int8_t retval_count, char** err, uint32_t* err_len);
