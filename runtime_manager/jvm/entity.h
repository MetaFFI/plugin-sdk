...
protected:
	CallableEntity(jvm_runtime_manager* runtime_manager,
		jclass cls,
		jmethodID method,
...
protected:
	VariableEntity(jvm_runtime_manager* runtime_manager,
		jclass cls,
		jfieldID field,
		const std::vector<jclass>& params_types,
		const std::vector<jclass>& retval_types,
...
{
public:
	JavaMethod(jvm_runtime_manager* runtime_manager,
		jclass cls,
		jmethodID method,
		const std::vector<jclass>& params_types,
		const std::vector<jclass>& retval_types,
...
{
public:
	JavaConstructor(jvm_runtime_manager* runtime_manager,
		jclass cls,
		jmethodID method,
		const std::vector<jclass>& params_types,
		const std::vector<jclass>& retval_types,
...
{
public:
	JavaFieldGetter(jvm_runtime_manager* runtime_manager,
		jclass cls,
		jfieldID field,
		const std::vector<jclass>& params_types,
		const std::vector<jclass>& retval_types,
...
{
public:
	JavaFieldSetter(jvm_runtime_manager* runtime_manager,
		jclass cls,
		jfieldID field,
		const std::vector<jclass>& params_types,
		const std::vector<jclass>& retval_types,
