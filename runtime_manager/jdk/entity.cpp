...
CallableEntity::CallableEntity(jdk_runtime_manager* runtime_manager,
	jclass cls,
	jmethodID method,
...
VariableEntity::VariableEntity(jdk_runtime_manager* runtime_manager,
	jclass cls,
	jfieldID field,
	const std::vector<jclass>& params_types,
	const std::vector<jclass>& retval_types,
...
JavaMethod::JavaMethod(jdk_runtime_manager* runtime_manager,
	jclass cls,
	jmethodID method,
	const std::vector<jclass>& params_types,
	const std::vector<jclass>& retval_types,
...
JavaConstructor::JavaConstructor(jdk_runtime_manager* runtime_manager,
	jclass cls,
	jmethodID method,
	const std::vector<jclass>& params_types,
	const std::vector<jclass>& retval_types,
...
JavaFieldGetter::JavaFieldGetter(jdk_runtime_manager* runtime_manager,
	jclass cls,
	jfieldID field,
	const std::vector<jclass>& params_types,
	const std::vector<jclass>& retval_types,
...
JavaFieldSetter::JavaFieldSetter(jdk_runtime_manager* runtime_manager,
	jclass cls,
	jfieldID field,
	const std::vector<jclass>& params_types,
	const std::vector<jclass>& retval_types,
