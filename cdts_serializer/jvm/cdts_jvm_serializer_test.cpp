...
TEST_CASE("Serialize and deserialize 2D array") {
    ...
    // Currently not implemented - should throw
    CHECK_THROWS_WITH(ser << (jobject)arr2d,
                      doctest::Contains("not yet implemented"));
...
TEST_CASE("Serialize and deserialize 3D array") {
    ...
    // Currently not implemented - should throw
    CHECK_THROWS_WITH(ser << (jobject)arr3d,
                      doctest::Contains("not yet implemented"));
...
TEST_CASE("Deserialize pre-filled CDTS with 2D array") {
    ...
    // Deserialize - currently not implemented, so this will fail
    cdts_jvm_serializer deser(g_env, data);
    // Note: 2D array deserialization not yet implemented in JVM serializer
...
TEST_CASE("Deserialize pre-filled CDTS with 3D array") {
    ...
    // Deserialize - currently not implemented
    cdts_jvm_serializer deser(g_env, data);
    // Note: 3D array deserialization not yet implemented in JVM serializer
}
...
TEST_CASE("Deserialize pre-filled CDTS with ragged array") {
    ...
    // Deserialize - currently not implemented
    cdts_jvm_serializer deser(g_env, data);
    // Note: Ragged array deserialization not yet implemented in JVM serializer
}
